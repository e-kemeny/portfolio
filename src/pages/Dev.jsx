...
const EXPERIENCE = [
  ...
  },
  {
    ...
    org: "GitHub Repository Trust Signals · Microsoft × Break Through Tech",
    period: "Current",
    points: [
        ...
        <section className="max-w-5xl mx-auto px-6 mt-28">
          ...
          <div className="space-y-10">
            {EXPERIENCE.map((job) => (
              <div
                key={job.role}
                className="grid sm:grid-cols-[1fr_2fr] gap-4 sm:gap-8 pt-6"
              >
                <div>
        ...
        <section className="max-w-5xl mx-auto px-6 mt-28">
          ...
          <ul className="grid sm:grid-cols-3 gap-5">
            {[
              ...
              <li
                key={item}
                className="rounded-lg border border-white/10 bg-surface p-4 text-sm leading-snug text-text/85"
              >
                {item}
              </li>
            ))}
      ...
      <Reveal>
        <section className="max-w-5xl mx-auto px-6 mt-28">
          <div className="rounded-lg border border-accent/30 bg-surface p-8 text-center">
            <h2 className="font-mono text-xl text-text mb-2">
